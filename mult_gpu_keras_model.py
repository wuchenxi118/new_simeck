...
def resnet_model(trainFilePath,testFilePath,batch_size,epochs,name,lr,key_file,which_line,which_letter,key_length,load_weight=False,weight_path = None,evalONtest = True):
    ...
    train_x,test_x,train_y,test_y = train_test_split(data_to_train,label_to_train_lb,test_size=0.3,shuffle=True)
...
resnet_model('/data/wuchenxi/new_simeck_data/signal15000train_val_test/train/',key_file='/data/wuchenxi/new_simeck_data/signal15000train_val_test/train_key.txt',
            ...
            testFilePath=None,
             batch_size=48,epochs=250,name='10401_1_2_v1_multgpu',#'6000_7.16_multlabel_changehwplace'
