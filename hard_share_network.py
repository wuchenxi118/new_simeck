...
def resnet_model_v3(trainFilePath,testFilePath,batch_size,epochs,name,lr,key_file,which_line,which_letter,load_weight=False,weight_path = None,evalONtest = True,validation_proportion=0.1,test_num = 100,rm_already_folder = True):
    input_tensor = Input(shape=(35000, 1))
    seq = input_tensor
    seq = BLOCK(seq, 64)
    seq = BatchNormalization(axis=1)(seq)
    ...
    h = model.fit_generator(train_generater,
                   ...
                   verbose=1,callbacks=callback,
                            validation_data=val_generater,validation_steps=step_per_epoch_default_val,
                            use_multiprocessing = True,workers=4,max_queue_size=30)
...
resnet_model_v3('/data/wuchenxi/new_simeck_data/signal108800_circle/signal108800',
            ...
            which_line=0,which_letter=0,
            testFilePath=None,
             batch_size=16,epochs=50,name='108800_0_0123_hardshare_v3(no_drop)_circle_generatermode',#'6000_7.16_multlabel_changehwplace'
